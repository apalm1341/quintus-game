...
var Quintus = function Quintus(opts) {
  ...
  */
  ...
  Q.setImageSmoothing = function(enabled) {
	...
	Q.ctx.imageSmoothingEnabled = enabled;  //this line fixed error!
    //Q.ctx.webkitImageSmoothingEnabled = enabled; //this line is screwed up shown in chrome dev tools for some weird reason...
